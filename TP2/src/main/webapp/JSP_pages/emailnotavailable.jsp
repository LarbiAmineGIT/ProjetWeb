          ...
          <div class="justify-content-center ">
	          ...
	          <div class="card o-hidden border-0 shadow-lg my-5 ">
	          	<div class="card-body p-0">
	          		<div class="row">
	          			<div class="col-lg-6 d-none d-lg-block" style="background: url('../bootstrap/sb2/img/wrongmailimage.svg'); background-position: center; background-size: cover;"></div>
	          			<div class="col-lg-6 border-left">
	          				<div class="p-5">
		          				<div class="text-center">
		          					<h1 class="h2 text-gray-900 mb-4">
		          						 <b>Adresse mail déja utilisée ! </b>
		          					</h1>
		          				</div>
								...
								<hr>
			          			...
			          			<section>
			          				<div class="mb-5"><h4> L'email est déja utilisé. 
			          				Par conséquent vous devez réessayer avec une autre adresse mail.</h4></div>
			          				<div class="mb-2 pb-2"><h4>Veuillez cliquer sur le bouton pour revenir à l'inscription</h4>  </div>
			          				
			          				<hr>
									
									<div class=" row">
		          						<div class="col-sm-12 mb-3 mb-sm-0">
		          							<a href="register.jsp"><button class="btn btn-primary btn-user btn-block"> Retour à l'inscription </button></a>
		          						</div>
		          					</div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="login.jsp">Vous avez déja un compte? Connectez vous!</a>
                                    </div>
